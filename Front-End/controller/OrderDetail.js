...
function getAllRefundOrders() {
    $.ajax({
        url: "http://localhost:8082/api/v1/orderDetail/getAllRefundOrders",
        method: "GET",
        dataType: "json",
        headers: {
...
function refundOrder() {
    ...
    $.ajax({
        url: "http://localhost:8082/api/v1/orderDetail/refundOrder",
        method: "DELETE",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
        },
...
function orderSearchByOrderId(orderId) {
    $.ajax({
        url: "http://localhost:8082/api/v1/orderDetail/searchByOrderId?orderId="+orderId,
        method: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
